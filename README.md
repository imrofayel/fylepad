...
5. Create tables, Mermaid diagrams, PlantUML charts, Code Blocks and much more.

6. **Rust Core**: Powered by a Rust core, it is fast, secure, and memory-efficient. No bulky Chromium browser under the hood here!

7. **Lightweight**: At just less than `10MB`, it is a compact powerhouse that won’t bloat your system.
