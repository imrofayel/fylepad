...
export const SearchAndReplace = Extension.create<SearchAndReplaceOptions, SearchAndReplaceStorage>({
  ...
  addCommands() {
    return {
      ...
      resetIndex:
        () =>
        ({ editor }) => {
          (editor.storage as any).searchAndReplace.resultIndex = 0;
      ...
      nextSearchResult:
        ...
        ({ editor }) => {
          ...
          if (results[nextIndex]) {
            (editor.storage as any).searchAndReplace.resultIndex = nextIndex;
          } else {
            (editor.storage as any).searchAndReplace.resultIndex = 0;
          }
      ...
      previousSearchResult:
        ...
        ({ editor }) => {
          ...
          if (results[prevIndex]) {
            (editor.storage as any).searchAndReplace.resultIndex = prevIndex;
          } else {
            (editor.storage as any).searchAndReplace.resultIndex = results?.length - 1;
          }
      ...
      replace:
        ...
        ({ editor, state, dispatch }) => {
          const { replaceTerm, results, resultIndex } = (editor.storage as any).searchAndReplace;
  ...
  addProseMirrorPlugins() {
    ...
    const setLastCaseSensitive = (t: boolean) =>
      ((editor.storage as any).searchAndReplace.lastCaseSensitive = t);
    const setLastResultIndex = (t: number) =>
      ((editor.storage as any).searchAndReplace.lastResultIndex = t);
