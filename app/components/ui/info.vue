<template>
  ...
  >
    <div
      class="fixed -top-1 right-0 cursor-pointer rounded-full bg-red-600 text-white opacity-90"
      :onclick="close"
    >
    ...
    <div class="flex items-center justify-between">
      ...
      <span
        class="text-xl tracking-tight drop-shadow-sm"
        style="font-family: &quot;SpaceGrotesk&quot;"
        >v3.0</span
      >
    </div>

    <p class="mt-3 text-lg">Your perfect note-taking app!</p>

    <p class="mt-4 flex items-center justify-between text-lg">
      <span class="">Can you star us on GitHub?</span>
      <a
        href="https://github.com/imrofayel/fylepad"
        target="_blank"
