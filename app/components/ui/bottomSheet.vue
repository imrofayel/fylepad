...
v-model="searchQuery" placeholder="Search"
                  ...
                  <button
title="Reset Font" class="border dark:bg-[#404040] dark:border-[#525252] dark:text-gray-50 rounded-xl border-[#c6c6c4] bg-white/80 text-black !px-[8px]   justify-center items-center cursor-pointer inline-block "
                    @click="resetFont">
...
:class="[
          ...
          <div class="flex my-3 space-x-4 items-center">
            <div
              ...
              <span>Color</span>
              <input
ref="colorPicker" type="color" :value="currentColor" class="color-picker hidden"
                @input="updateColor" >
              <button class="ml-2 p-1 rounded-full hover:bg-gray-100" @click="$refs.colorPicker.click()">
                <div class="h-5 w-5 rounded-full border border-[#c6c6c4]" :style="{ backgroundColor: currentColor }" />
              </button>

              <svg
xmlns="http://www.w3.org/2000/svg" width="22" viewBox="0 0 24 24" class="drop-shadow-sm"
                @click="resetColor">
                <path
fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                  stroke-width="1.5"
...
fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="pl-2 flex space-x-1 text-black/40 dark:text-white/40"><button
