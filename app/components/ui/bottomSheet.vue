<template>
  <div>
    <transition name="slide-up">
      <div
        v-if="isOpen"
        class="drop-shadow-cooltop fixed right-0 bottom-0 left-0 z-50 rounded-xl rounded-t-xl border border-b-0 border-[#c6c6c4] bg-white/90 backdrop-blur-2xl dark:border-[#525252] dark:bg-[#404040] dark:text-gray-50"
        :style="{ maxHeight: '70%', overflowY: 'auto' }"
      >
        <div class="flex items-center justify-end px-4 py-3 dark:border-[#2a3828]">
          <button
            class="tab-item flex cursor-pointer items-center justify-center rounded-xl border border-[#c6c6c4] bg-white p-2 px-2 text-black backdrop-blur-xl dark:border-[#484747] dark:bg-[#171717] dark:text-gray-50"
            @click="closeSheet"
          >
            <svg
        ...
        <div class="px-4 pb-4">
          <Menu as="div" class="relative text-left">
            <div>
              <MenuButton
                class="flex cursor-pointer items-center justify-center rounded-xl border border-[#c6c6c4] bg-white p-2 px-3 text-black backdrop-blur-xl dark:border-[#484747] dark:bg-[#171717] dark:text-gray-50"
              >
                <span class="mr-2 text-[18px]" :style="{ fontFamily: selectedFont }">{{
            ...
            >
              ...
              >
                ...
                <div v-else class="flex flex-col space-y-2 p-2 text-black">
          ...
          <div class="my-3 flex items-center space-x-4">
            <div
              class="flex cursor-pointer items-center justify-center space-x-2 rounded-xl border border-[#c6c6c4] bg-white p-2 px-3 text-[18px] text-black backdrop-blur-xl dark:border-[#484747] dark:bg-[#171717] dark:text-gray-50"
            >
              <span>Color</span>
              <input
                ref="colorPicker"
              ...
              >
                <div
                  class="h-5 w-5 rounded-full border border-[#c6c6c4]"
          ...
          <div class="flex space-x-4">
            <div class="flex space-x-4 text-black/30 dark:text-white/40">
              <div
                class="flex cursor-pointer items-center justify-center space-x-2 rounded-xl border border-[#c6c6c4] bg-white p-2 px-3 text-[18px] text-black backdrop-blur-xl dark:border-[#484747] dark:bg-[#171717] dark:text-gray-50"
              >
                <svg
                ...
                <div class="flex space-x-1 pl-2 text-black/40 dark:text-white/40">
                  <button
                    :class="{
                      'text-black hover:text-black dark:text-white/90 dark:hover:text-white/90':
                        isActiveAlign('left'),
                    }"
                    class="rounded-lg p-1 hover:text-gray-500 dark:hover:text-gray-200"
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke-linejoin="round"
                        stroke-width="1.5"
                        d="M3 3h18M3 9h8m-8 6h18M3 21h8"
                        color="currentColor"
                      />
                    </svg>
                  </button>
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke-linejoin="round"
                        stroke-width="1.5"
                        d="M3 3h18M8 9h8M3 15h18M8 21h8"
                        color="currentColor"
                      />
                    </svg>
                  </button>
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke-linejoin="round"
                        stroke-width="1.5"
                        d="M3 3h18m-8 6h8M3 15h18m-8 6h8"
                        color="currentColor"
                      />
                    </svg>
                  </button>
...
const filteredFonts = computed(() => {
  return fonts.filter((font) => font.toLowerCase().includes(searchQuery.value.toLowerCase()));
});
